...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    banner = (
            ...
            f"WELCOME TO <tg-emoji emoji-id=\"5289722755871162900\">🎬</tg-emoji>\n"
            f"▬▬▬▬▬▬▬▬▬▬▬\n"
            f"𝐆𝐀𝐌𝐄𝐒 𝐀𝐍𝐃 𝐎𝐓𝐓 𝐁𝐎𝐓\n"
            f"▬▬▬▬▬▬▬▬▬▬▬\n"
            f"<tg-emoji emoji-id=\"5895242866057286055\">📌</tg-emoji> QUICK GUIDE :\n"
            ...
            f"▬▬▬▬▬▬▬▬▬▬▬\n"
            f"<tg-emoji emoji-id=\"5895242866057286055\">📌</tg-emoji> PLEASE CHOOSE A MENU BELOW <tg-emoji emoji-id=\"5406745015365943482\">👇</tg-emoji>"
        )
